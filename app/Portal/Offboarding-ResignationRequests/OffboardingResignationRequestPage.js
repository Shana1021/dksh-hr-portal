...
function AcknowledgeResignationPopup({
  name,
  department,
  reason,
  onClose,
      ...
      >
        ...
        <div className={styles["scroll-container"]}>
          <div className={styles["modal-content"]}>
            ...
            <div className={styles["header"]} id="last">
              <b>Reason:</b> {reason}
            </div>
          </div>
          ...
          <div className={styles["modal-content"]}>
            <h4 className={styles["h4"]}>Manager Email Address</h4>
            <input
              className={styles["input-field"]}
              type="email"
              name="managerEmail"
          ...
          <div className={styles["modal-content"]}>
            ...
            <input type="file" name="acceptanceLetter" required={accepted} />
          </div>
        </div>

        <button
          className={`module-button ${styles["confirm-btn"]}`}
          type="submit"
        >
          Confirm
        </button>
...
export default function OffboardingResignationRequestsPage({
  resignationRequests,
}) {
        ...
        {resignationRequests.map((resignationRequest, index) => (
          ...
          >
            ...
            <div className={styles["card-body"]}>
              <h4>
                {resignationRequest.profile.firstName}{" "}
                {resignationRequest.profile.lastName}
              </h4>
              <p className={styles["department"]}>
                {resignationRequest.profile.department}
              </p>
            </div>
          </div>
        ))}
